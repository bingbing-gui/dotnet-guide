...
## CSharp编程语言
### [CSharp编程语言规范](https://github.com/dotnet/csharplang)
## Windows客户端生态
### 思维导图
...
### [SMTPClient](https://learn.microsoft.com/en-us/dotnet/api/system.net.mail.smtpclient?view=net-8.0)
